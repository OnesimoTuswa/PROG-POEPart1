...
public class Registration {
    ...
    if(underscore == true && username.length() <= 5){
        System.out.print("Username succesfully captured");
    }
    else{
    ...
    System.out.println("Enter username");
    usernamelog = userinput1.nextLine();
    
    Scanner passinput1 = new Scanner(System.in);
    System.out.println("Enter password");
    passwordlog = passinput1.nextLine();
        
    boolean usernamecheck = usernamelog.equals(username2);
    boolean passwordcheck = passwordlog.equals(password2);
    
    if(usernamecheck == true && passwordcheck == true)
        System.out.println("Welcome, " + firstname1 + " " + lastname1 + " it is great to see you again.");
    else
